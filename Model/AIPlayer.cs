...
public abstract class AIPlayer : Player
{
    ...
    public override AttackResult Attack()
    {
        ...
        while (result.Value!=ResultOfAttack.Hit && result.Value != ResultOfAttack.Miss && result.Value != ResultOfAttack.GameOver && !SwinGame.WindowCloseRequested)// generate coordinates for shot// take shot
;

...
Module UtilityFunctions
    ...
    Private ReadOnly SMALL_SEA As Color = SwinGame.RGBAColor(6, 60, 194, 255)
    ...
    Public Sub DrawSmallField(ByVal grid As ISeaGrid, ByVal thePlayer As Player)
        Const SMALL_FIELD_LEFT As Integer = 39, SMALL_FIELD_TOP As Integer = 300
        Const SMALL_FIELD_WIDTH As Integer = 234, SMALL_FIELD_HEIGHT As Integer = 234
        Const SMALL_FIELD_CELL_WIDTH As Integer = 23, SMALL_FIELD_CELL_HEIGHT As Integer = 23
        Const SMALL_FIELD_CELL_GAP As Integer = 2

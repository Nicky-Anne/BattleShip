...
Public MustInherit Class AIPlayer : Inherits Player
    ...
    Public Overrides Function Attack() As AttackResult
        ...
        Loop While result.Value <> ResultOfAttack.Hit AndAlso result.Value <> ResultOfAttack.Miss AndAlso result.Value <> ResultOfAttack.GameOver AndAlso Not SwinGame.WindowCloseRequested

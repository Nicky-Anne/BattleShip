...
static class UtilityFunctions
{
	...
	/// The small sea.
	/// </summary>
    private readonly static Color SMALL_SEA = SwinGame.RGBAColor(6, 60, 194, 255);
	...
	/// <summary>
	/// Ises the mouse in rectangle.
	/// </summary>
	/// <returns><c>true</c>, if mouse in rectangle was ised, <c>false</c> otherwise.</returns>
    ...
    public static bool IsMouseInRectangle(int x, int y, int w, int h)
    {
		...
		/// <param name="showShips">If set to <c>true</c> show ships.</param>
        Point2D mouse;
        bool result = false;
    ...
    public static void DrawSmallField(ISeaGrid grid, Player thePlayer)
    {
        ...
        const int SMALL_FIELD_TOP = 300;
        const int SMALL_FIELD_WIDTH = 234;
        const int SMALL_FIELD_HEIGHT = 234;
        const int SMALL_FIELD_CELL_WIDTH = 23;
        const int SMALL_FIELD_CELL_HEIGHT = 23;
        const int SMALL_FIELD_CELL_GAP = 2;

		/// <summary>
		/// Draws the custom field.
		/// </summary>
		/// <param name="grid">Grid.</param>
		/// <param name="thePlayer">The player.</param>
		/// <param name="small">If set to <c>true</c> small.</param>
		/// <param name="showShips">If set to <c>true</c> show ships.</param>
		...
		/// <param name="cellGap">Cell gap.</param>
